...
export function RegistrationScreen() {
  ...
  const validate = () => {
    ...
    if (formRole === 'contractor' && workers.trim() && (!/^\d+$/.test(workers.trim()) || Number(workers) < 0)) next.workers = 'Enter a valid whole number of workers.';
  ...
  return (
    <div className="px-5 pt-6 pb-28 max-w-3xl mx-auto">
      ...
      <Card className="p-5 space-y-4">
        ...
        {formRole === 'contractor' && <>
          <Field label={c.company} value={company} onChange={setCompany} placeholder={c.companyExample} />
