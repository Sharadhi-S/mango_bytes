...
export function AIChatbot() {
  ...
  const answer = (question: string) => {
    ...
    if (q.includes('saving') || q.includes('salary') || q.includes('deduct')) return 'Smart Savings is dynamic. On tough days it can stay around 0.5%, on a normal day it is about 2%, and on a strong day it can rise to as much as 6% depending on market demand, weather, safety and work conditions. This keeps saving affordable without putting too much pressure on workers.';
